...
var PoolClientManager = (function () {
  ...
  PoolClientManager.prototype.execBatch = function (statements, firstSuccess) {
  ...
  PoolClientManager.prototype.execScalar = function (sql, args) {
...
function execBatch(pool, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var client, c, result0, listStatements, arrPromise, e_1, arrPromise, e_2;
      ...
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
            ...
            return [2, exec(pool, statements[0].query, statements[0].params)];
          }
        ...
        case 3:
          _a.sent();
          return [4, client.query(statements[0].query, statements[0].params)];
        case 4:
          result0 = _a.sent();
          if (result0.rowCount === 0) {
            return [2, 0];
          }
          listStatements = statements.slice(1);
          arrPromise = listStatements.map(function (item) {
...
function execBatchWithClient(client, statements, firstSuccess) {
  return __awaiter(this, void 0, void 0, function () {
    var c, result0, listStatements, arrPromise, e_3, arrPromise, e_4;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!statements || statements.length === 0) {
        ...
        case 11:
          _a.sent();
          arrPromise = statements.map(function (item) { return client.query(item.query, toArray(item.params)); });
          return [4, Promise.all(arrPromise).then(function (results) {
...
var PostgreWriter = (function () {
  function PostgreWriter(pool, table, attributes, toDB, buildParam) {
    this.table = table;
...
var PostgreBatchWriter = (function () {
  function PostgreBatchWriter(pool, table, attributes, toDB, buildParam) {
    this.table = table;
    this.attributes = attributes;
    this.write = this.write.bind(this);
    if (typeof pool === 'function') {
